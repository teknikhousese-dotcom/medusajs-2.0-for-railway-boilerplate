    ...
    <div className="content-container py-10 small:py-14">
      ...
      {posts.length === 0 ? (
        ...
        <>
          {featured && (
            <Link href={`/blogg/${featured.slug}`} className="group mt-10 block overflow-hidden rounded-3xl border border-ui-border-base bg-white hover:shadow-[0_18px_50px_rgba(20,22,28,0.10)] transition-shadow">
              <div className="grid grid-cols-1 large:grid-cols-2">
                <div className="relative aspect-[16/10] large:aspect-auto large:h-full overflow-hidden">
                ...
                <div className="flex flex-col justify-center p-7 small:p-10">
                  ...
                  <h2 className="mt-2 text-2xl small:text-3xl font-semibold tracking-tight text-[#14161C] group-hover:text-[#F50000] transition-colors">{featured.title}</h2>
          ...
          <div className="mt-8 grid grid-cols-1 small:grid-cols-2 large:grid-cols-3 gap-6">
            {rest.map((p) => (
