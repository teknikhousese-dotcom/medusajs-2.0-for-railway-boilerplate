...
.thtabs .bar{display:flex;gap:22px;border-bottom:1px solid var(--line);flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch;margin-bottom:20px}
.thtabs .bar::-webkit-scrollbar{display:none}
.thtabs .tb{font-family:var(--round);font-weight:600;font-size:14.5px;color:var(--sub);padding:12px 2px;border:0;border-bottom:3px solid transparent;background:none;cursor:pointer;white-space:nowrap;flex:0 0 auto;margin-bottom:-1px}
.thtabs .tb.active{color:var(--ink);border-color:var(--red)}
.thtabs .body{max-width:880px;min-width:0}
.thdesc{color:#3f3f52;font-size:14.5px;line-height:1.6;overflow-wrap:anywhere}
...
.thdesc ul{list-style:disc}
.thdesc ol{list-style:decimal}
.thdesc li::marker{color:#F50000}
...
.thdesc table{display:block;max-width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch;border-collapse:collapse;margin:14px 0;font-size:13.5px}
.thdesc table:not(:has(thead))>tbody{display:table;width:100%}
.thdesc iframe,.thdesc video{max-width:100%}
...
.thspec{width:100%;border-collapse:collapse;font-size:14px;max-width:640px}
.thspec tr{border-bottom:1px solid var(--line)}
.thspec td{padding:12px 0}
.thspec td:first-child{color:var(--sub);width:44%}
.thspec td:last-child{font-weight:600;color:var(--ink);text-align:right;overflow-wrap:anywhere;padding-left:12px}
