...
const CSS = [
  ...
  ".hdv-img{position:absolute;inset:0;animation:hdvIn .65s cubic-bezier(.2,.8,.2,1) both;-webkit-box-reflect:below 0px linear-gradient(transparent 82%,rgba(255,255,255,.22))}",
