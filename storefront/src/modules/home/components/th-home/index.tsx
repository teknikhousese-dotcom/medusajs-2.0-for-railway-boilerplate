...
.th{--red:#F50000;--red-d:#D10000;--ink:#1b1714;--ink2:#2c2621;--sub:#6f685f;--faint:#a49c92;--bg:#faf8f6;--card:#fff;--line:#efeae5;--line2:#e6e0da;--green:#1a9d55;--amber:#ffb300;--star:#FFB020;
  --round:"Baloo 2",ui-rounded,"SF Pro Rounded","Segoe UI",system-ui,sans-serif;
...
.th .badge{display:inline-flex;align-items:center;gap:8px;background:#fff;border-radius:999px;padding:8px 15px;font-family:var(--round);font-weight:700;font-size:12.5px;color:var(--red-d);box-shadow:0 3px 12px rgba(27,23,20,.06)}
.th .hero h1{font-family:var(--round);font-weight:800;font-size:clamp(34px,5vw,58px);line-height:1.03;letter-spacing:-.02em;margin:16px 0}
...
.th .finder .flab{font-family:var(--round);font-weight:700;font-size:13px;color:var(--ink);margin-bottom:12px;display:flex;gap:8px;align-items:center}
...
.th .finder .go{background:var(--red);color:#fff;border:0;border-radius:13px;padding:0 22px;font-family:var(--round);font-weight:800;font-size:15px;white-space:nowrap;display:inline-flex;align-items:center}
...
.th .heroart .fc b{display:block;font-family:var(--round);font-weight:700;color:var(--ink)}
.th .heroart .fc .p{color:var(--red);font-weight:800}
.th .heroart .fc .ok{color:var(--green);font-weight:700;font-size:11.5px}
...
.th .shead h2{font-family:var(--round);font-weight:800;font-size:clamp(22px,3vw,28px);letter-spacing:-.02em}
.th .shead a{font-family:var(--round);color:var(--red);font-weight:700;font-size:14px;white-space:nowrap}
...
.th .cat b{font-family:var(--round);font-weight:800;font-size:15.5px;color:#fff;position:relative;z-index:2;letter-spacing:-.01em;text-shadow:0 1px 8px rgba(0,0,0,.28)}
...
.th .deal h3{font-family:var(--round);font-weight:800;font-size:28px;letter-spacing:-.02em;max-width:66%}
.th .deal p{color:#6f685f;margin:9px 0 18px;font-size:14.5px;max-width:66%}
.th .deal.d2 p{color:#c9c2ba}
.th .deal .db{align-self:flex-start;background:var(--red);color:#fff;font-family:var(--round);font-weight:700;padding:12px 22px;border-radius:12px;font-size:14px}
.th .deal .burst{position:absolute;right:24px;top:24px;width:72px;height:72px;border-radius:50%;background:var(--amber);color:#1b1714;font-family:var(--round);font-weight:800;display:flex;flex-direction:column;align-items:center;justify-content:center;transform:rotate(6deg)}
...
.th .repair .rey{font-family:var(--round);color:#ff7a6a;font-weight:800;font-size:12px;letter-spacing:.1em;text-transform:uppercase}
.th .repair h3{font-family:var(--round);font-size:clamp(22px,3.4vw,30px);font-weight:800;margin:12px 0 10px;letter-spacing:-.02em}
.th .repair p{color:#c9c2ba;max-width:440px;font-size:15px}
.th .steps{display:flex;gap:8px;margin-top:20px;flex-wrap:wrap}
.th .steps .st{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.14);border-radius:12px;padding:11px 15px;font-family:var(--round);font-size:13px;font-weight:700}
.th .steps .st span{display:block;color:#ff7a6a;font-size:11px;font-weight:600}
.th .repair .cta{margin-top:22px;display:inline-flex;background:var(--red);color:#fff;font-family:var(--round);font-weight:800;border-radius:12px;padding:13px 22px;font-size:14px}
...
.th .brand{display:flex;align-items:center;justify-content:center;height:66px;border:1px solid var(--line);border-radius:14px;background:var(--card);font-family:var(--round);font-weight:800;font-size:15px;color:var(--ink);transition:.15s}
...
.th .rev .who{font-family:var(--round);font-size:13px;color:var(--sub);font-weight:700}

/* intro */
.th .intro{background:var(--bg);border:1px solid var(--line);border-radius:18px;padding:34px}
.th .intro h3{font-family:var(--round);font-size:22px;font-weight:800;margin-bottom:6px;letter-spacing:-.01em}
.th .intro p{color:var(--ink2);font-size:14.5px;max-width:860px;margin-top:10px}

/* newsletter */
.th .news{background:linear-gradient(135deg,#1b1714,#332c26);border-radius:24px;padding:40px;display:flex;align-items:center;justify-content:space-between;gq�:24px;flex-wrap:wrap;color:#fff}
...
export default function ThHome({ region, products = [] }: { region?: any; products?: any[] }) {
  ...
  return (
    <div className="th">
      ...
      {/* REVIEWS */}
      <section className="blk" style={{ paddingTop: 0 }}><div className="wrap">
        <div className="shead"><h2>Vad våra kunder säger</h2><span className="r" style={{ color: "var(--star)", fontWeight: 800 }}>Trustpilot 4,9 ★</span></div>
        <div className="revs">
