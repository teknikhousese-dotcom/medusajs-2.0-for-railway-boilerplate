...
function payBadge(pm?: string) {
  const __pmk = (pm || "").toUpperCase(); if (__pmk === "SWISH") { return <img src="https://images.ctfassets.net/zrqoyh8r449h/5dYSjiUWZq3ITy9acKxDGq/b11b197ae975131489c79311f0f9abeb/Swish_Logo_Secondary_Light_BG_P3.png?w=120" alt="Swish" title="Swish" width={18} height={18} style={{ display: "inline-block", verticalAlign: "middle", marginRight: "6px" }} /> }
  if (!pm) return null
