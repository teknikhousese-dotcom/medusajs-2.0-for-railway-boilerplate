...
function payBadge(pm?: string) {
  if ((pm || "").toUpperCase() === "SWISH") { return <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 43, height: 15, borderRadius: 3, background: "#E5007D", boxSizing: "border-box", verticalAlign: "middle", overflow: "hidden" }}><img src="https://images.ctfassets.net/zrqoyh8r449h/6q1uVUC3T7NZYzyRItsYvY/9e98fc846112f03bd7cc476cad5dbb22/Swish_Logo_Secondary_Dark_BG_P3.png?w=140" alt="Swish" style={{ maxWidth: "88%", maxHeight: "82%", display: "block" }} /></span> }
