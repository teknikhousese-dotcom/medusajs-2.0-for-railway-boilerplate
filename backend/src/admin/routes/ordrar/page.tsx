...
function payBadge(pm?: string) {
  if ((pm || "").toUpperCase() === "SWISH") { return <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 43, height: 15, borderRadius: 3, background: "#fff", border: "1px solid #e5e7eb", boxSizing: "border-box", verticalAlign: "middle", overflow: "hidden" }}><img src="https://images.ctfassets.net/zrqoyh8r449h/5dYSjiUWZq3ITy9acKxDGq/b11b197ae975131489c79311f0f9abeb/Swish_Logo_Secondary_Light_BG_P3.png?w=140" alt="Swish" style={{ maxWidth: "90%", maxHeight: "78%", display: "block" }} /></span> }
