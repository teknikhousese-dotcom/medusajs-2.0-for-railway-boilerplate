...
function payBadge(pm?: string) {
  const __pmk = (pm || "").toUpperCase(); if (__pmk === "SWISH") { return <img src={SWISH_ICON_DATA} alt="Swish" title="Swish" width={18} height={18} style={{ display: "inline-block", verticalAlign: "middle", marginRight: "6px" }} /> }
  if (!pm) return null
