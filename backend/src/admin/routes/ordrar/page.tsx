...
function payBadge(pm?: string) {
  if ((pm || "").toUpperCase() === "SWISH") { return <img src="https://images.ctfassets.net/zrqoyh8r449h/5dYSjiUWZq3ITy9acKxDGq/b11b197ae975131489c79311f0f9abeb/Swish_Logo_Secondary_Light_BG_P3.png?w=140" alt="Swish" style={{ height: 16, width: "auto", display: "inline-block", verticalAlign: "middle" }} /> }
