...
function KontrollpanelPage() {
  ...
  const menu: MenuItem[] = useMemo(() => ([
    ...
    { emo: "🧰", lab: "Hantera produkter", href: `${ADMIN}/products`, subs: [
      ...
      { lab: "Produktsortering", href: `${ADMIN}/categories` },
      { lab: "Produktfiltrering", href: `${ADMIN}/categories` },
    ]},
    { emo: "💡", lab: "Rekommendationer", section: "rekommendationer" },
    { emo: "🗂️", lab: "Hantera Varugrupper", href: `${ADMIN}/categories`, subs: [
      { lab: "Ny varugrupp", href: `${ADMIN}/categories/create` },
      { lab: "Ordning på varugrupperna", href: `${ADMIN}/categories` },
    ]},
    ...
    { emo: "🔤", lab: "Översättningar", href: `${ADMIN}/settings` },
